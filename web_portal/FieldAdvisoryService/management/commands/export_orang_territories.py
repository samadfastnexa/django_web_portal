...
class Command(BaseCommand):
    help = "Export leaf territories from SAP HANA (4B-ORANG_APP) for preview or later seeding"
    ...
    def handle(self, *args, **options):
        ...
        print("============================================================")
        print("ORANG Territories Export (preview)")
        print("============================================================")
        ...
        if write_file:
            with open(write_file, "w", encoding="utf-8") as f:
                json.dump({"meta": {"companies": report["companies"], "source_company_db": "4B-ORANG_APP"}, "territories": export_items}, f, ensure_ascii=False, indent=2)
            print("------------------------------------------------------------")
